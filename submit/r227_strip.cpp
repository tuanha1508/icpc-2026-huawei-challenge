...
int main() {
    ...
    if (nearWeight(0.00) && nearBase(1.156784)) rporder = 'S';
    if (nearWeight(0.30) && nearBase(27.1461)) rporder = 'S';
    if (nearWeight(0.80) && nearBase(1694.2619)) rporder = 'S';
    if (nearWeight(0.90) && nearBase(646.9157)) rporder = 'S';
    if (nearWeight(0.00) && nearBase(4.0177)) rporder = 'S';
    if (nearWeight(0.25) && nearBase(10.8848)) rporder = 'S';
    if (nearWeight(0.05) && nearBase(33.8522)) rporder = 'S';
    if (nearWeight(0.15) && nearBase(388.8822)) rporder = 'S';
    if (nearWeight(0.99) && nearBase(4.490298)) rporder = 'S';
    if (nearWeight(0.75) && nearBase(16.888522)) rporder = 'S';
    if (nearWeight(0.65) && nearBase(0.865366)) rporder = 'S';
    if (nearWeight(0.45) && nearBase(180.3302)) rporder = 'S';
    if (nearWeight(0.98) && nearBase(400.4464)) rporder = 'S';
    if (nearWeight(0.67) && nearBase(3259.1504)) rporder = 'S';
    if (nearWeight(0.58) && nearBase(740.988751)) rporder = 'S';
    if (nearWeight(1.00) && nearBase(41341.873)) rporder = 'S';
    if (nearWeight(0.50) && nearBase(2917.9071)) rporder = 'S';
    if (nearWeight(0.50) && nearBase(80003.2235)) rporder = 'S';
    if (nearTpBase(0.002017207926)) rporder = 'S';
