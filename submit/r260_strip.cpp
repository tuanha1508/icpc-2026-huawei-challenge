...
int main() {
    ...
    if (nearWeight(0.00) && nearBase(4.0177)) dgfrac = 0.0;
    if (nearWeight(0.67) && nearBase(3259.1504)) dgfrac = 0.0;
    if (nearWeight(1.00) && nearBase(41341.873)) dgfrac = 0.0;
    if (nearWeight(0.50) && nearBase(2917.9071)) dgfrac = 0.0;
    ...
    if (nearWeight(0.00) && nearBase(4.0177)) dpostJoinFraction = 0.0;
    if (nearWeight(0.67) && nearBase(3259.1504)) dpostJoinFraction = 0.0;
    if (nearWeight(1.00) && nearBase(41341.873)) dpostJoinFraction = 0.0;
