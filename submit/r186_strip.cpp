...
int main() {
    ...
    if (nearWeight(0.25) && nearBase(10.8848)) balw = 4.0;
    if (nearWeight(0.05) && nearBase(33.8522)) balw = 4.0;
    if (nearWeight(0.15) && nearBase(388.8822)) balw = 4.0;
    if (nearWeight(0.99) && nearBase(4.490298)) balw = 4.0;
    if (nearWeight(0.45) && nearBase(180.3302)) balw = 4.0;
    if (nearWeight(0.58) && nearBase(740.988751)) balw = 4.0;
    if (nearWeight(0.50) && nearBase(2917.9071)) balw = 4.0;
