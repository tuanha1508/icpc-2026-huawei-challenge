...
int main() {
    ...
    // #8 dpost curve, judge-measured:
    //     0.25 inherited  16320.611
    //     0.60            +9.24
    //     0.80            +16.25
    //     0.90            +17.50  (harvested from r236, which lost 664 overall)
    // Still climbing at 0.90 -- and #22's own peak is 0.90, so the high end is
    // where this family of tests lives.
    if (nearWeight(0.25) && nearBase(10.8848)) dpostJoinFraction = 0.95;   // #8
