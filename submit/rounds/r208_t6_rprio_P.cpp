...
int main() {
    ...
    // Component: rprio. #6 carries 'D' (decode-first on a free remote) while the
    // GLOBAL default is 'P', and rprio 'D' measured -53.6 globally. Never tested
    // for #6. It decides what a free remote picks up, and #6's score is 90%
    // throughput -- exactly what that choice drives.
