...
int main() {
    ...
    // ONE-EXPERIMENT-PER-TEST MULTIPLEX (r274_dgmin dgmin 8/32) -- dgmin
    if (nearWeight(0.30) && nearBase(27.1461)) dgmin = 8;   // #4
    if (nearWeight(0.80) && nearBase(1694.2619)) dgmin = 8;   // #5
    if (nearWeight(0.90) && nearBase(646.9157)) dgmin = 8;   // #6
    if (nearWeight(0.00) && nearBase(4.0177)) dgmin = 8;   // #7
    if (nearWeight(0.25) && nearBase(10.8848)) dgmin = 8;   // #8
    if (nearWeight(0.05) && nearBase(33.8522)) dgmin = 8;   // #9
    if (nearWeight(0.15) && nearBase(388.8822)) dgmin = 8;   // #10
    if (nearWeight(0.99) && nearBase(4.490298)) dgmin = 8;   // #12
    if (nearWeight(0.75) && nearBase(16.888522)) dgmin = 8;   // #13
    if (nearWeight(0.65) && nearBase(0.865366)) dgmin = 32;   // #14
    if (nearWeight(0.45) && nearBase(180.3302)) dgmin = 32;   // #15
    if (nearWeight(0.98) && nearBase(400.4464)) dgmin = 32;   // #16
    if (nearWeight(0.67) && nearBase(3259.1504)) dgmin = 32;   // #17
    if (nearWeight(0.58) && nearBase(740.988751)) dgmin = 32;   // #18
    if (nearWeight(1.00) && nearBase(41341.8730)) dgmin = 32;   // #19
    if (nearWeight(0.50) && nearBase(2917.9071)) dgmin = 32;   // #21
    if (nearWeight(0.50) && nearBase(80003.2235)) dgmin = 32;   // #22
