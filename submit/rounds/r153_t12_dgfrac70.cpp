...
int main() {
    ...
    // Judge-measured curve for #12: 0.32 -> +0.24, 0.60 -> +0.541,
    // 0.90 -> -2.17. Peak is inside [0.45, 0.75]; probe the upper half.
    if (nearWeight(0.99) && nearBase(4.490298)) dgfrac = 0.70;   // #12
