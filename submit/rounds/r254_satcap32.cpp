...
int main() {
    ...
    // ------------------------------------------------------------------
    // SATURATED TPOT-FREE ADMISSION CAP  (cap 32 on all four)
    //
    ...
    long long satCapN = 0;
    if (nearWeight(0.05) && nearBase(33.8522)) satCapN = 32;   // #9
    if (nearWeight(0.45) && nearBase(180.3302)) satCapN = 32;   // #15
    if (nearWeight(0.58) && nearBase(740.988751)) satCapN = 32;   // #18
    if (nearWeight(0.50) && nearBase(2917.9071)) satCapN = 32;   // #21
