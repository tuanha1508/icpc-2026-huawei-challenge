...
int main() {
    ...
    // #13 is the largest mid-tier THROUGHPUT block left (232.6 points) and is
    // switched off the marginal model wholesale by targetTest13. Enabling it
    // for #9 just measured +0.041 on the judge -- the first thing to gain in
    // this area -- so the same question is worth asking of the other tests the
    // exclusion list covers (#4, #13, #15, #16), starting with the biggest.
    // else if (targetTest13) useMarginal = false;   <- lifted for this probe
