...
int main() {
    ...
    // MULTIPLEXED: rporder 'S' = prefill-queue shortest-first. Binds only 2/60 globally because
    // most tests never have more than one prefill queued; the deep-queue tests are
    // exactly where it can matter. Only #7 and #13 have ever carried it.
