...
int main() {
    ...
    // r292 PROBE.  w_tp = 1.00 EXACTLY -- latency worth nothing.  Straight to the end of the
    // axis, where #5 peaked, rather than stepping through 0.90.
    if (nearWeight(1.00) && nearBase(41341.8730)) { dgfrac = 1.00; dgfracForced = true; }   // #19
