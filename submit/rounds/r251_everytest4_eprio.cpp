...
int main() {
    ...
    for (;;) {
        ...
        // EVERY-TEST eprio: force "CDBA" on tests that currently take whatever
        // the marginal model picks each frame. Only #5 #8 #10 #13 carry a
        // forced string today; on #13 the decode-order axis alone was worth
        // 23.89 points, so a fixed order is not a neutral choice.
        {
            struct { double w, db; } g[] = {
                {0.00, 1.156784},   // #3
                {0.30, 27.1461},   // #4
                {0.00, 4.0177},   // #7
                {0.05, 33.8522},   // #9
