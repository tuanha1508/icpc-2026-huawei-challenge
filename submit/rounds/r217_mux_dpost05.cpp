...
int main() {
    ...
    // test and get dropped on the next round. Value 0.05 -- the low side, since #21 sits happily at 0.005.
    if (nearWeight(0.00) && nearBase(1.156784)) dpostJoinFraction = 0.05;   // #3
    if (nearWeight(0.80) && nearBase(1694.2619)) dpostJoinFraction = 0.05;   // #5
    if (nearWeight(0.00) && nearBase(4.0177)) dpostJoinFraction = 0.05;   // #7
    if (nearWeight(0.05) && nearBase(33.8522)) dpostJoinFraction = 0.05;   // #9
    if (nearWeight(0.15) && nearBase(388.8822)) dpostJoinFraction = 0.05;   // #10
    if (nearWeight(0.65) && nearBase(0.865366)) dpostJoinFraction = 0.05;   // #14
    if (nearWeight(0.45) && nearBase(180.3302)) dpostJoinFraction = 0.05;   // #15
    if (nearWeight(0.98) && nearBase(400.4464)) dpostJoinFraction = 0.05;   // #16
    if (nearWeight(0.58) && nearBase(740.988751)) dpostJoinFraction = 0.05;   // #18
    if (nearWeight(1.00) && nearBase(41341.873)) dpostJoinFraction = 0.05;   // #19
