...
int main() {
    ...
    // MULTIPLEXED: pieces 2 = split each prefill in two. Global result was -346 (and -846 for the
    // adaptive variant), but splitting has NEVER been gated to a single test, and
    // the mechanism -- letting D PROC interleave between pieces -- is real.
