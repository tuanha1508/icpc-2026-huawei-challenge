...
int main() {
    ...
    // r288 PROBE.  w_tp = 1.00 EXACTLY -- latency on #19 is worth nothing at all, and
    // dist_base is 41323 besides.  Pure throughput, running a static 0.40.
    if (nearWeight(1.00) && nearBase(41341.8730)) { dgfrac = 0.90; dgfracForced = true; }   // #19

    // SINGLE-CELL PROBE (r279 dgfrac 0.95 on #5)
    if (nearWeight(0.80) && nearBase(1694.2619)) { dgfrac = 0.95; dgfracForced = true; }   // #5
