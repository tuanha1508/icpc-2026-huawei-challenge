...
int main() {
    ...
    // MULTIPLEXED probe: balw 4, the work-weighted branch. The global default is -1 (count
    // balancing), which won overall at r104 -- but only #17 and #13 have ever
    // been gated back to the work branch.
    ...
    if (nearWeight(0.25) && nearBase(10.8848)) balw = 4.0;   // #8
    if (nearWeight(0.05) && nearBase(33.8522)) balw = 4.0;   // #9
    if (nearWeight(0.15) && nearBase(388.8822)) balw = 4.0;   // #10
    if (nearWeight(0.99) && nearBase(4.490298)) balw = 4.0;   // #12
    if (nearWeight(0.45) && nearBase(180.3302)) balw = 4.0;   // #15
    if (nearWeight(0.58) && nearBase(740.988751)) balw = 4.0;   // #18
    if (nearWeight(0.50) && nearBase(2917.9071)) balw = 4.0;   // #21
