...
int main() {
    ...
    // r63: the adaptive-N admission controller is OFF by default.
    // It is a tuned point estimate of a quantity whose downstream optimizer
    // selects the cheap realizations, so substituting the estimate is
    // systematically biased. Measured: +387.64 on 66 generated robust tests
    // (win 14 / lose 0) and +2.6/test on the 504-test corpus. nfactor = 0
    // disables the initial Ntarget cap and both shrink branches below.
    double nfactor = 0.0;
