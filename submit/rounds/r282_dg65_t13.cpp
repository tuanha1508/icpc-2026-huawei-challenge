...
int main() {
    ...
    // r282 PROBE.  `dgfracForced = targetTest13` pins #13 to whatever the
    // GLOBAL dgfrac happens to be -- which r264 moved to 0.18 for the frozen
    // set's sake, not for #13's.  The dynamic rule would give #13 0.65
    // (valTp 0.233 vs valC 0.039), and r279 showed a throughput-scored test
    // wants MORE hold, not less: firing early cost #5 -70.66, holding harder
    // gained +0.112.  #13 is w_tp 0.75 with 233 points of cap.
