...
int main() {
    ...
    // This is the first thing to move it. Push further: the direction is confirmed, the peak is not.
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.60;   // #6
