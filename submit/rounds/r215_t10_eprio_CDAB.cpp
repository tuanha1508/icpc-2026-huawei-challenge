...
int main() {
    ...
    for (;;) {
        ...
        // Component: #10 eprio "CDBA" -> "CDAB". Both are prefill-first and
        // differ only in decode order (D PRE vs D POST first). That exact swap
        // was worth 23.89 points on #13, so the axis carries real weight.
