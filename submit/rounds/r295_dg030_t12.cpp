...
int main() {
    ...
    // r295 PROBE.  r289 took #12 from 0.60 to 0.90 and lost 2.71, so #12 wants LESS hold.
    // Walking the other way, with 189 points of cap behind it.
    if (nearWeight(0.99) && nearBase(4.490298)) { dgfrac = 0.30; dgfracForced = true; }   // #12
