...
int main() {
    ...
    // r291 PROBE.  #5's D PRE hold wanted the maximum: 0.749 -> 0.95 gave
    // +0.112 and 0.95 -> 1.00 another +0.499.  dpostJoinFraction is the same
    // hold on the D POST side and #5 has been sitting at 0.25.
    if (nearWeight(0.80) && nearBase(1694.2619)) dpostJoinFraction = 1.00;   // #5
