...
int main() {
    ...
    // lost 650 overall.
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.00;   // #6
    // r297 PROBE.  Same flush applied to #6, which carries 584 points of cap
    // and whose D PRE side just proved inert (r294 dgfrac 1.00 = exact null).
