...
int main() {
    ...
    // #6 dpost curve, all judge-measured totals:
    //     0.00  inherited baseline
    //     0.25  **16319.510  BEST**
    //     0.40  16310.822
    //     0.55  16219.375   (-91 -- sharp cliff)
    //     0.90  16284.529
    // #6 was the ONLY test pinned at dpost = 0, and moving off zero is worth
    // about +11 points. Peak is inside (0, 0.40) with 0.25 leading; the cliff
    // past 0.40 is steep, so refine on the low side.
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.32;   // #6
