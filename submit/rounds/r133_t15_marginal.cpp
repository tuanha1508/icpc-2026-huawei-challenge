...
int main() {
    ...
    bool useMarginal = !((nearWeight(0.05) && !nearBase(33.8522)) ||  // #9 class
                         ...
                         // #15 (109.4 points, latency-limited) exempted from the
                         // class exclusion, exactly as #9 was; the class stays
                         // intact for every other w_tp = 0.45 test.
                         (nearWeight(0.45) && nearBase(180.3302) && false) ||  // #15
                         legacyQuarter);
