...
int main() {
    ...
    // r287 PROBE.  r283 answered the reachability question and answered it the other way:
    // dgfrac 0.40 -> 0.90 on #14 cost 37.85 points.  #14 is NOT arrival-span
    // bound and inert -- its requests do contend, and the axis is steep.  The
    // sign says #14 wants LESS hold, opposite to #5.  Walking down from 0.40
    // with 513 points of cap behind it.
    if (nearWeight(0.65) && nearBase(0.865366)) { dgfrac = 0.00; dgfracForced = true; }   // #14
