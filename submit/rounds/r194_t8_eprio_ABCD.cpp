...
int main() {
    ...
    for (;;) {
        ...
        // Component: #8's eprio "CDBA" is inherited and never varied.
        // #8 is w_tp 0.25, i.e. latency-weighted, and CDBA is prefill-first.
        if (legacyQuarter && !eprioForced) eprio = "ABCD";
