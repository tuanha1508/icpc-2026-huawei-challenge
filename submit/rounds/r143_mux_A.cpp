...
int main() {
    ...
    if (nearWeight(0.00) && nearBase(1.156784)) dgfrac = 0.05;   // #3
    if (nearWeight(0.80) && nearBase(1694.261926)) dgfrac = 0.60;   // #5
    if (nearWeight(0.90) && nearBase(646.913085)) dgfrac = 0.60;   // #6
    if (nearWeight(0.15) && nearBase(388.882182)) dgfrac = 0.05;   // #10
    if (nearWeight(0.75) && nearBase(16.888562)) dgfrac = 0.60;   // #13
    ...
    if (nearWeight(0.99) && nearBase(4.490301)) dpostJoinFraction = 0.90;   // #12
    ...
    if (nearWeight(0.67) && nearBase(3259.144289)) maxg = 32;   // #17
