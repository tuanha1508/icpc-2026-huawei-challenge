...
int main() {
    ...
    if (nearWeight(0.25) && nearBase(10.8848)) dgfrac = 0.12;   // #8 curve sweep
    if (nearWeight(0.15) && nearBase(388.8822)) dgfrac = 0.60;   // #10 curve sweep
    ...
    // ==================================================================
    // CURVE SWEEP (point B).  Placed AFTER every other dpost/dgfrac block on
    ...
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.10;   // #6
    if (nearWeight(0.30) && nearBase(27.1461)) dpostJoinFraction = 0.10;   // #4
    if (nearWeight(0.75) && nearBase(16.888522)) dpostJoinFraction = 0.20;   // #13
    if (nearWeight(0.67) && nearBase(3259.1504)) dpostJoinFraction = 0.30;   // #17
