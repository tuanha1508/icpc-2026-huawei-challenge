...
int main() {
    ...
    // r289 PROBE.  w_tp = 0.99, 189 points of cap, an 11% makespan gap to tp_UB, and a
    // static dgfrac of 0.60.
    if (nearWeight(0.99) && nearBase(4.490298)) { dgfrac = 0.90; dgfracForced = true; }   // #12
