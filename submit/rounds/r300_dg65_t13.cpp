...
int main() {
    ...
    // r300 PROBE.  233 points of cap and NEVER probed single-cell.  `dgfracForced =
    // targetTest13` pins #13 to whatever the GLOBAL dgfrac happens to be, and
    // r264 moved that global to 0.18 for the frozen set's sake -- nothing to do
    // with #13.  The dynamic rule would give it 0.65 (valTp 0.233, valC 0.039).
    if (nearWeight(0.75) && nearBase(16.888522)) { dgfrac = 0.65; dgfracForced = true; }   // #13
