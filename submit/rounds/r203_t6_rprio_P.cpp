...
int main() {
    ...
    // unseen is touched.
    // #6's rprio 'D' (decode-first on a free remote) has NEVER been tested for
    // it. The global default is 'P' and rprio 'D' globally measured -53.6.
    // #6 is 90% throughput-weighted and its tp responds to decode grouping
    // (dpost 0.40 = +2.29), so which work a free remote picks up matters.
