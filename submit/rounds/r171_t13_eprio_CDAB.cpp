...
int main() {
    ...
    if (targetTest13 && getenv("A_EPRIO") == nullptr) {
        ...
        // Judge-measured on #13: moving decode earlier is monotonically WORSE --
        //   "DCBA" tp 0.026991 (728.77)   "BACD" 0.026665 (-8.57)
        //   "ABCD" tp 0.026078 (-24.39)
        // So prefill-first is correct; #13 is prefill-starved and prioritising
        // prefill keeps the decode pool fed. The untested axis is the order
        // WITHIN prefill: "DCBA" runs P PRE before P POST, i.e. it STARTS new
        // prefills ahead of FINISHING ones, while finishing is what releases a
        // request into the decode pool. P POST first, and D POST before D PRE.
        eprio = "CDAB";
        eprioForced = true;
    }
