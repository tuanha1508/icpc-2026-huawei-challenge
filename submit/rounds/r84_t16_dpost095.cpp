...
int main() {
    ...
    if (getenv("A_DPOSTFRAC") == nullptr) {
        ...
        // r84 -- does #16 saturate like #22 did? #16 gained +0.530 at dpost 0.90
        // (tpot 114.038 -> 71.670, -37.2%). #22 saturated: 0.90 / 0.95 / 0.98 all
        // byte-identical. If #16 has NOT yet saturated, more remains; if it has,
        // this returns exactly 0 and the mechanism is fully closed.
        else if (nearWeight(0.98) && nearBase(400.4447)) dpostJoinFraction = 0.95; // #16
