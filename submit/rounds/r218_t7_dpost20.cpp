...
int main() {
    ...
    // r216's ten-test dpost multiplex gained +1.09 and the per-test rows show ALL
    // of it is #7: 915.32 (0.15) -> 916.41 (0.25) -> 913.36 (0.40).
    // The other nine gates were exact no-ops, so r216 was already
    // winners-only. #7 is w_tp = 0.00 -- pure latency, 84.7 points of headroom
    // -- and its dpost peak sits between 0.15 and 0.40.
    if (nearWeight(0.00) && nearBase(4.0177)) dpostJoinFraction = 0.20;   // #7
