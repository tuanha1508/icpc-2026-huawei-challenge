...
int main() {
    ...
    if (nearWeight(0.80) && nearBase(1694.2619)) dgfrac = 0.60;
    if (nearWeight(0.98) && nearBase(400.4464)) dgfrac = 0.60;
    if (nearWeight(1.00) && nearBase(41341.873)) dgfrac = 0.95;
    if (nearWeight(0.50) && nearBase(2917.9071)) dgfrac = 0.60;
    if (nearWeight(0.50) && nearBase(80003.2235)) dgfrac = 0.60;
    ...
    if (nearWeight(1.00) && nearBase(41341.873)) dpostJoinFraction = 0.95;
