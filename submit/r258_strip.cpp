...
int main() {
    ...
    if (nearWeight(0.90) && nearBase(646.9157)) dpostMinMembers = 4;
    if (nearWeight(0.30) && nearBase(27.1461)) dpostMinMembers = 4;
    if (nearWeight(0.15) && nearBase(388.8822)) dpostMinMembers = 4;
    if (nearWeight(0.75) && nearBase(16.888522)) dpostMinMembers = 4;
