...
int main() {
    ...
    if (nearWeight(0.25) && nearBase(10.8848)) dgfrac = 0.12;
    if (nearWeight(0.15) && nearBase(388.8822)) dgfrac = 0.60;
    ...
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.10;
    if (nearWeight(0.30) && nearBase(27.1461)) dpostJoinFraction = 0.10;
    if (nearWeight(0.75) && nearBase(16.888522)) dpostJoinFraction = 0.20;
    if (nearWeight(0.67) && nearBase(3259.1504)) dpostJoinFraction = 0.30;
