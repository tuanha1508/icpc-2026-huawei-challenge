...
int main() {
    ...
    if (nearWeight(0.80) && nearBase(1694.2619)) dpostJoinFraction = 0.40;
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.40;
    if (nearWeight(0.00) && nearBase(4.0177)) dpostJoinFraction = 0.40;
    if (nearWeight(0.05) && nearBase(33.8522)) dpostJoinFraction = 0.40;
    if (nearWeight(0.15) && nearBase(388.8822)) dpostJoinFraction = 0.40;
    if (nearWeight(0.45) && nearBase(180.3302)) dpostJoinFraction = 0.40;
    if (nearWeight(0.98) && nearBase(400.4464)) dpostJoinFraction = 0.40;
    if (nearWeight(0.58) && nearBase(740.988751)) dpostJoinFraction = 0.40;
