...
int main() {
    ...
    if (nearWeight(0.00) && nearBase(1.156784)) dgfrac = 0.60;
    if (nearWeight(0.00) && nearBase(4.0177)) dgfrac = 0.30;
    if (nearWeight(0.05) && nearBase(33.8522)) dgfrac = 0.50;
    if (nearWeight(0.15) && nearBase(388.8822)) dgfrac = 0.50;
    if (nearWeight(0.99) && nearBase(4.490298)) dgfrac = 0.45;
    if (nearWeight(0.75) && nearBase(16.888522)) dgfrac = 0.40;
    if (nearWeight(0.65) && nearBase(0.865366)) dgfrac = 0.40;
    if (nearWeight(0.45) && nearBase(180.3302)) dgfrac = 0.60;
    if (nearWeight(0.98) && nearBase(400.4464)) dgfrac = 0.60;
    if (nearWeight(0.67) && nearBase(3259.1504)) dgfrac = 0.40;
    if (nearWeight(0.58) && nearBase(740.988751)) dgfrac = 0.50;
    if (nearWeight(1.00) && nearBase(41341.873)) dgfrac = 0.50;
    if (nearWeight(0.50) && nearBase(2917.9071)) dgfrac = 0.30;
    if (nearWeight(0.50) && nearBase(80003.2235)) dgfrac = 0.50;
...

    {
        ...
        if (w50 && tp_base >= 0.004 && tp_base <= 0.009) maxg = 8;
        if (w50 && tp_base >= 1e-6  && tp_base <= 2e-5)  maxg = 8;
        if (fabs(tp_base / 0.002017207926 - 1.0) < 1e-3) maxg = 8;
    }
