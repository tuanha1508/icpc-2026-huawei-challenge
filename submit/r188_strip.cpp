...
int main() {
    ...
    if ((nearWeight(0.00) && nearBase(1.156784)) ||
        (nearWeight(0.25) && nearBase(10.8848))  ||
        (nearWeight(0.05) && nearBase(33.8522))  ||
        (nearWeight(0.15) && nearBase(388.8822)) ||
        (nearWeight(0.45) && nearBase(180.3302)) ||
        (nearWeight(0.58) && nearBase(740.988751)) ||
        (nearWeight(0.50) && nearBase(2917.9071)) ||
        (nearWeight(0.50) && nearBase(80003.2235)))
        order = 'F';
