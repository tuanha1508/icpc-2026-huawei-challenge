...
int main() {
...

    {
        ...
        if (w50 && tp_base >= 0.015 && tp_base <= 0.040) pieces = 0;
        if (w50 && tp_base >= 0.004 && tp_base <= 0.009) pieces = 2;
        if (w50 && tp_base >= 1e-6  && tp_base <= 2e-5)  pieces = 3;
        if (fabs(tp_base / 0.002017207926 - 1.0) < 1e-3) pieces = 2;
    }
    ...
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.25;

    if (nearWeight(0.30) && nearBase(27.1461)) dpostJoinFraction = 0.45;
    if (nearWeight(0.90) && nearBase(646.9157)) dpostJoinFraction = 0.20;
    if (nearWeight(0.00) && nearBase(4.0177)) dpostJoinFraction = 0.30;
    if (nearWeight(0.25) && nearBase(10.8848)) dpostJoinFraction = 0.95;
    if (nearWeight(0.99) && nearBase(4.490298)) dpostJoinFraction = 0.05;
    if (nearWeight(0.75) && nearBase(16.888522)) dpostJoinFraction = 0.25;
    if (nearWeight(0.45) && nearBase(180.3302)) dpostJoinFraction = 0.30;
    if (nearWeight(0.67) && nearBase(3259.1504)) dpostJoinFraction = 0.20;
    if (nearWeight(0.58) && nearBase(740.988751)) dpostJoinFraction = 0.35;
    if (nearWeight(1.00) && nearBase(41341.873)) dpostJoinFraction = 0.40;
    if (nearWeight(0.50) && nearBase(2917.9071)) dpostJoinFraction = 0.30;
    if (nearWeight(0.50) && nearBase(80003.2235)) dpostJoinFraction = 0.70;
