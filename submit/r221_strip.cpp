...
int main() {
    ...
    if (nearWeight(0.00) && nearBase(1.156784)) dgfrac = 0.08;
    if (nearWeight(0.05) && nearBase(33.8522)) dgfrac = 0.08;
    if (nearWeight(0.15) && nearBase(388.8822)) dgfrac = 0.08;
    if (nearWeight(0.65) && nearBase(0.865366)) dgfrac = 0.08;
    if (nearWeight(0.45) && nearBase(180.3302)) dgfrac = 0.08;
    if (nearWeight(1.00) && nearBase(41341.873)) dgfrac = 0.08;
    if (nearWeight(0.50) && nearBase(80003.2235)) dgfrac = 0.08;
