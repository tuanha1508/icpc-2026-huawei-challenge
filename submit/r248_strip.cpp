...
int main() {
    ...
    if (nearWeight(0.00) && nearBase(1.156784)) rprio = 'D';
    if (nearWeight(0.30) && nearBase(27.1461)) rprio = 'D';
    if (nearWeight(0.80) && nearBase(1694.2619)) rprio = 'D';
    if (nearWeight(0.05) && nearBase(33.8522)) rprio = 'D';
    if (nearWeight(0.15) && nearBase(388.8822)) rprio = 'D';
    if (nearWeight(0.99) && nearBase(4.490298)) rprio = 'D';
    if (nearWeight(0.65) && nearBase(0.865366)) rprio = 'D';
    if (nearWeight(0.45) && nearBase(180.3302)) rprio = 'D';
    if (nearWeight(0.98) && nearBase(400.4464)) rprio = 'D';
    if (nearWeight(0.58) && nearBase(740.988751)) rprio = 'D';
    if (nearWeight(1.00) && nearBase(41341.873)) rprio = 'D';
    if (nearWeight(0.50) && nearBase(2917.9071)) rprio = 'D';
    if (nearWeight(0.50) && nearBase(80003.2235)) rprio = 'D';
