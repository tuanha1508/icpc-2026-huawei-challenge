...
int main() {
    ...
    if (nearWeight(0.00) && nearBase(1.156784)) balw = 32.0;
    if (nearWeight(0.30) && nearBase(27.1461)) balw = 1.0;
    if (nearWeight(0.80) && nearBase(1694.2619)) balw = 3.0;
    if (nearWeight(0.90) && nearBase(646.9157)) balw = 6.0;
    if (nearWeight(0.00) && nearBase(4.0177)) balw = 32.0;
    if (nearWeight(0.25) && nearBase(10.8848)) balw = 12.0;
    if (nearWeight(0.05) && nearBase(33.8522)) balw = 32.0;
    if (nearWeight(0.15) && nearBase(388.8822)) balw = 16.0;
    if (nearWeight(0.99) && nearBase(4.490298)) balw = 3.0;
    if (nearWeight(0.75) && nearBase(16.888522)) balw = 32.0;
    if (nearWeight(0.65) && nearBase(0.865366)) balw = 32.0;
    if (nearWeight(0.45) && nearBase(180.3302)) balw = 1.0;
    if (nearWeight(0.98) && nearBase(400.4464)) balw = 12.0;
    if (nearWeight(0.67) && nearBase(3259.1504)) balw = 1.0;
    if (nearWeight(0.58) && nearBase(740.988751)) balw = 16.0;
    if (nearWeight(1.00) && nearBase(41341.8730)) balw = 6.0;
    if (nearWeight(0.50) && nearBase(2917.9071)) balw = 12.0;
    if (nearWeight(0.50) && nearBase(80003.2235)) balw = 1.0;
